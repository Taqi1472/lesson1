...
const bouquet:{name:string,price:number,discription:string}={
    name:"spring delight",
    price:200,
...
bouquets.push(
{name:"summer bliss",price:300,discription:"beautifull arrgument of summer floowers "},
{name:"blue flower",price:345,discription:"beautifull arrgument of blue flowers"}
);
...
else{console.log(`age is ${age} the person is elder`)};
...
const username:string[]=["Admin","Ali","Hassan","Hussain","Zain"];
...
const usernames:string[]=["admin","shahan","kamran","rizwan","babar"];
// function case
...
if (usernames[a].toLowerCase()==="admin"){
    ...
    else {console.log(`Heloo ${usernames[a]}, thank you for logging again `);
}
}
    };
