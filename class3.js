...
// second methoud
let size = "Large";
let message = "This is my favourite shirt";
make_shirt(size, message);
console.log(chalk.bgBlue("Question37"));
function makeshirt(size = "Large", message = "Beautyfull Shirt") {
...
function discribe_city(city, country = "unknown Country") {
...
let magiciannames = ["Harry porter", "David copperfield", "Hermione Granger",
...
const magiciannamess = ["Harry porter", "David copperfield", "Hermione Granger",
    "Professor albu dumbledore", "Ron weasley"];
function show_magicians(magiciannamess) {
...
function make_great(magiciannamess) {
